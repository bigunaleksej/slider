(function ($) {
    ...
    SliderCore.prototype.setSwipeListener = function () {
        ...
        function makeSwipe(e) {
            ...
            e.srcElement.parentElement.addEventListener("transitionend", resetTransitionState, false);

            function resetTransitionState(e) {
                e.currentTarget.removeEventListener("transitionend", resetTransitionState);
                transitionOn = false;
    ...
    SliderCore.prototype.crateSlider = function (images) {
        ...
        for (var i = 0, length = images.length; i < length; i++) {
            ...
            slideImg = createEl('img', { draggable: false });
